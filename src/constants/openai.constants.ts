...
[
    ...
    },
    {
        ...
        config: {
            ...
            sublabel: note for single choice field (optional, default value: 'Choose your answer'),
            options: the available options to answer the question (optional, default value: []),
            otherOption: z
              .object(
                {
                  isDisplayed: z.boolean({
                    required_error: FORM_ERROR_MESSAGES.REQUIRED_FIELD_IN_MULTIPLE_CHOICE_CONFIG,
    ...
    },
    {
        ...
        config: {
            ...
            sublabel: note for multiple choice field (optional, default value: 'Choose your answers'),
            options: the available options to answer the question (optional, default value: []),
            otherOption: z
              .object(
                {
    ...
    {
        Upload Image: For uploading images
        config: {
